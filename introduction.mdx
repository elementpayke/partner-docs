...
| **International deposit accounts** | EUR / GBP / USD (+ optional USDC wallet) | Entity KYC → open deposit accounts (`/partner/entities/*`) → deposit instructions / **card funding** → same-currency fiat book-transfers; stablecoin sends in **beta** |
