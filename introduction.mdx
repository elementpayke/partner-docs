...
| **International deposit accounts** | EUR / GBP / USD / CAD (+ USDC / USDT wallets) | Entity KYC → open deposit accounts (`/partner/entities/*`) → deposit instructions / **card funding** (Limited) → **card issuing** (active USD) → fiat book-transfers / conversion / **stablecoin sends** |
