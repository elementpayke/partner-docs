...
| **International deposit accounts** | EUR / GBP / USD (+ optional USDC wallet) | Entity KYC → open deposit accounts (`/partner/entities/*`) → deposit instructions / **card funding** → **card issuing** (active USD) → same-currency fiat book-transfers / **stablecoin sends** |
