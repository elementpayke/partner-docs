...
| **International deposit accounts** | EUR / GBP / USD (+ optional USDC wallet) | Entity KYC → open deposit accounts (`/partner/entities/*`) → deposit instructions / **card acquiring** → same-currency fiat book-transfers; stablecoin sends in **beta** |
