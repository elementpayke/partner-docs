...
<Note>
If **Signed accepts** is enabled on your API key in Console, see [Customer-signed accepts](/orders/signed-accepts). Empty-body accept will be rejected.
</Note>
...
- [Customer-signed accepts](/orders/signed-accepts) — optional EIP-712 accept for non-custodial partners
