...
These values match Yellow Card’s published [Sandbox Testing](https://docs.yellowcard.engineering/docs/sandbox-testing-api) guide (`1111111111` / `0000000000` and `+{countryCode}1111111111` / `+{countryCode}0000000000`).
