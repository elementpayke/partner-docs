...
<Warning>
Do **not** try to settle sandbox OffRamp by sending testnet crypto to the deposit wallet. Use the `Successful` name trigger. Real on-chain deposits are for **production** only.
</Warning>
