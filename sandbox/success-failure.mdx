...
<Warning>
These numbers and name tokens apply to **sandbox only**. Using `1111111111` / `+2541111111111` (or random accounts) in **production** will fail validation or settlement. Always use real customer MSISDNs and bank accounts live.
</Warning>
