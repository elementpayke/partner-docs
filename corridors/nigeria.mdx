...
<Warning>
Do **not** pick ids whose codes look like `NGN_ACCOUNT_USDC` / `USDC_NGN_ACCOUNT` (or labels such as “NGN account to USDC” / “USDC to NGN account”). Those are deposit-account ledger rails, not retail bank transfer institutions.
</Warning>
