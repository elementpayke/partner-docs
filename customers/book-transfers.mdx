...
5. Insufficient funds / headroom failures use the same partner-neutral error style as stablecoin sends.
...
| Insufficient balance | `422` | Lower amount or fund source account |
