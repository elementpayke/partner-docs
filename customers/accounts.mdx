...
| KE individual opens USD fiat | `422` + `unsupported_region` | Open EUR/GBP/CAD (or stablecoin); for USD use a non-KE individual, or a business where Element Pay has confirmed USD eligibility |
