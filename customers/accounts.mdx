...
If account routes are called before `ready`, expect **409** with partner-neutral `data` such as `deposit_account_status` and `reason: banking_profile_incomplete`.
...
|-----------|---------|--------|
| Banking gate not ready | `409` + `banking_profile_incomplete` | Poll `deposit_account` until `ready` |
