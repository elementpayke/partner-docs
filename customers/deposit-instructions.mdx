...
<Warning>
**Sandbox:** returned coordinates may not credit usable balance for outbound testing. Contact Element Pay for a sandbox credit if you need to exercise [stablecoin sends](/customers/stablecoin-sends). **Live:** show these details to the end-customer and wait for real funding.
</Warning>
